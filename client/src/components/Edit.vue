    ...
    <div class="col-md-4">
      <h1>Edit Book</h1>
        ...
        <b-form-group id="input-group-3" label="Price:" label-for="input-3">
          <b-form-input id="input-2" v-model="item.price" required placeholder="Enter price"></b-form-input>
        </b-form-group>

        <b-form-group id="input-group-4" label="Stock:" label-for="input-4">
          <b-form-input id="input-2" v-model="item.stock" required placeholder="Enter stock" type="number"></b-form-input>
        </b-form-group>
