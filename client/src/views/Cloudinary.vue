<template>
  <div class="cl-upload">
    ...
    <form v-on:submit.prevent="upload">
      ...
      <!-- allow the user to select an image file and when they have selected it call a function to handle this event-->
...
export default {
  ...
  methods: {
    ...
    upload: function () {
      ...
      console.log('gua lagi nyoba di sini')

      const fr = new FileReader()
      fr.readAsDataURL(this.file)
      fr.onload = function () {
        console.log('ini apa sih', fr.result)
      }

      console.log('ini yg punya cloudinary')
