<template>
  <div class="container">
    <div class="container-fluid">
      ...
      <hr />
      <form id="contactForm" @submit.prevent="addCategory">
        <div class="form-row">
          <div class="col-12 col-md-6" id="message">
            <h2 class="h4"> Category&#39;s detail<small></small></h2>
...
export default {
  ...
  methods: {
    addCategory() {
      ...
      this.$store.dispatch('addCategory', this.categoryData)
        .then(() => {
          loader.hide();

          this.$toasted.show('New category added', {
            theme: 'outline',
            position: 'top-right',
            duration: 3000,
          });
